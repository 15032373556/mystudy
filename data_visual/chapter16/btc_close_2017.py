...
#将数据加载到一个列表中
filename = 'C:\\Users\\刘邦国\\PycharmProjects\\study\\data_visual\\chapter16\\btc_close_2017.json'
...
with open('收盘价Dashboard.html','w',encoding='utf8') as html_file:
    ...
    for svg in [
        ...
        html_file.write('    <object type="image/svg+xml" data="{0}" height=460></object>\n'.format(svg))
